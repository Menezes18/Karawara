...
public sealed class SystemMiniMap : MonoBehaviour
{
    ...
    void CreateMapPlane(bool realTime)
    {
        ...
        {
            GameObject plane = Instantiate(MiniMapDataBD.Instance.mapPlane.gameObject) as GameObject;
            miniMapPlane = plane.GetComponent<MiniMapPlaneBase>();
    ...
    public void SetPointMark(Vector3 Position)
    {
        ...
        mapPointer.GetComponent<PointerBaseMap>().SetColor(playerColor);
    }
